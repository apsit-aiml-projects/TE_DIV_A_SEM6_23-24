    ...
    try:
        ...
        if len(index) > 0:
            ...
            if similarity_scores.size != 0:
                ...
                return render_template('recommend.html', error_message="Error: Similarity scores array is empty!")
        else:
            return render_template('recommend.html', error_message="Error: Book not found!")
    except Exception as e:
